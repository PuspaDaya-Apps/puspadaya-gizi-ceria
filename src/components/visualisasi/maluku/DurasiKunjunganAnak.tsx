...
const DurasiKunjunganAnakMlk: React.FC<DataSectionProps> = ({
  region,
  desa,
  posyandu,
  month,
        ...
        <ResponsiveContainer width="100%" height={400}>
          ...
          >
            ...
            <XAxis
              ...
              axisLine={false}
              tickLine={false}
              tick={false} // <--- INI PERUBAHANNYA: Menghilangkan teks "Januari 2025" di sumbu
              height={50}
              label={{
                value: `Periode ${getMonthName(effectiveMonth)} ${effectiveYear}`, // Label ini TETAP ADA
            ...
            <YAxis
              ...
              tickFormatter={(value) => {
                if (value % 1 !== 0) return Math.ceil(value * 100) / 100;
                return value;
              }}
              label={{
                value: "Durasi (menit)",
...
export default DurasiKunjunganAnakMlk;
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const currentMonth = now.getMonth() + 1; // +1 karena getMonth() return 0-11

        // 2. Tentukan nilai yang akan dikirim ke API
        let apiYear = year;
        let apiMonth = month;

        // Jika tahun & bulan props SAMA dengan tahun & bulan sekarang
        if (year === currentYear && month === currentMonth) {
            apiYear = 0;
            apiMonth = 0;
        }

        // 3. Bangun query string
        const query = new URLSearchParams({
          kabupaten_kota: region,
          ...(desa ? { desa } : {}),
          ...(posyandu ? { posyandu } : {}),
          tahun: apiYear.toString(), // Gunakan variabel apiYear (0 atau value asli)
          bulan: apiMonth.toString(), // Gunakan variabel apiMonth (0 atau value asli)
        });
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <DataCard
            icon={
              ...
              >
                {/* ... existing path ... */}
                <path d="M10 13.0002C10.5523 13.0002 11 12.5525 11 12.0002C11 11.448 10.5523 11.0002 10 11.0002C9.44771 11.0002 9 11.448 9 12.0002C9 12.5525 9.44771 13.0002 10 13.0002Z" />
                <path d="M15 12.0002C15 12.5525 14.5523 13.0002 14 13.0002C13.4477 13.0002 13 12.5525 13 12.0002C13 11.448 13.4477 11.0002 14 11.0002C14.5523 11.0002 15 11.448 15 12.0002Z" />
          ...
          <DataCard
            icon={
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
               <path d="M18.5 9.00002H16.5M16.5 9.00002L14.5 9.00002M16.5 9.00002L16.5 7M16.5 9.00002L16.5 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
...
export default DatasSectionBwi;
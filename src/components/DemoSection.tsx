        ...
        <div className="border-t-4 border-yellow-400 p-8 rounded-2xl shadow-md max-w-4xl mx-auto">
          ...
          <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden">
            <iframe 
              ...
              src='https://www.youtube.com/embed/BaOGrQDbnxU?si=deiO6gWf4W_W9B49'
          ...
          <p className="text-blue-600 mt-6 font-medium text-center">Langkah-langkah awal menggunakan Puspadaya</p>
        </div>
      </div>
    </section>
  );
